...
export const LeftLine1 = (props: LineProps) => {
  return (
    <div className="flex flex-col h-fit w-full">
      ...
      <div className="w-full h-screen rounded-tr-lg border-t-4 border-r-4 border-textLit"></div>
    </div>
  );
};
...
export const LeftLine2 = (props: LineProps) => {
  return (
    <div className="flex flex-col h-fit w-full">
      ...
      <div className="w-full h-12 rounded-tr-lg border-t-4 border-r-4 border-textLit"></div>
    </div>
  );
};
  ...
  return (
    <div className="pb-line-cont-main pb-10 ">
      <div className=" col-start-2 sm:col-start-3 col-span-1 h-full w-full z-20 pb-5">
        <div className="h-20 w-full  rounded-bl-lg border-b-4 border-l-4 border-textLit"></div>
        <div className="block sm:hidden text-right text-sm mt-auto h-8">
          copyright Ichacodes &copy;{new Date().getFullYear()}
        </div>
      </div>
      <div className="hidden sm:block text-right text-sm mt-auto h-8">
        copyright Ichacodes &copy;{new Date().getFullYear()}
      </div>
    </div>
  );
